...
import { 
  ...
  ChevronRight, Flame, User, Shield, CreditCard, CalendarPlus, Navigation,
  Phone, Mail, Globe, Wifi, Car, Coffee
} from 'lucide-react';
...
const demoStandings = [
  { rank: 1, name: 'Mike Thompson', handicap: 8.2, rounds: 8, avgNet: 71.2, points: 24 },
  { rank: 2, name: 'Sarah Chen', handicap: 9.5, rounds: 8, avgNet: 72.8, points: 22 },
  { rank: 3, name: 'John Martinez', handicap: 7.8, rounds: 7, avgNet: 73.1, points: 20 },
  { rank: 4, name: 'Lisa Anderson', handicap: 10.1, rounds: 8, avgNet: 74.5, points: 18 },
  { rank: 5, name: 'David Park', handicap: 8.9, rounds: 8, avgNet: 75.0, points: 16 },
  { rank: 6, name: 'Jennifer Wu', handicap: 9.2, rounds: 7, avgNet: 75.8, points: 14 },
  { rank: 7, name: 'Robert Lee', handicap: 8.5, rounds: 8, avgNet: 76.2, points: 12 },
  { rank: 8, name: 'Maria Garcia', handicap: 9.8, rounds: 7, avgNet: 77.1, points: 10 }
];

const demoRoster = {
  'Flight A (0-9)': [
    { name: 'Mike Thompson', handicap: 8.2, joinedDate: 'Dec 5, 2024' },
    { name: 'Sarah Chen', handicap: 9.5, joinedDate: 'Dec 3, 2024' },
    { name: 'John Martinez', handicap: 7.8, joinedDate: 'Dec 8, 2024' },
    { name: 'Lisa Anderson', handicap: 10.1, joinedDate: 'Dec 10, 2024' }
  ],
  'Flight B (10-18)': [
    { name: 'David Park', handicap: 12.4, joinedDate: 'Dec 12, 2024' },
    { name: 'Jennifer Wu', handicap: 14.2, joinedDate: 'Dec 15, 2024' },
    { name: 'Robert Lee', handicap: 11.8, joinedDate: 'Dec 18, 2024' },
    { name: 'Maria Garcia', handicap: 15.5, joinedDate: 'Dec 20, 2024' }
  ],
  'Flight C (19-27)': [
    { name: 'Chris Wilson', handicap: 22.1, joinedDate: 'Dec 22, 2024' },
    { name: 'Amanda Brown', handicap: 19.8, joinedDate: 'Dec 25, 2024' },
    { name: 'Kevin Davis', handicap: 24.5, joinedDate: 'Dec 28, 2024' }
  ]
};
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        {activeTab === 'schedule' && (
          <div>
            ...
            <div className="space-y-4">
              {demoSchedule.map((week) => (
                <div key={week.week} className="bg-[#1a1a1a] rounded-xl p-6 border border-gray-800">
                  <div className="flex items-start justify-between">
                    <div>
                      <div className="flex items-center gap-2 mb-2">
                        <span className="text-sm font-medium text-emerald-500">Week {week.week}</span>
        ...
        {activeTab === 'roster' && (
          <div>
            <div className="flex items-center justify-between mb-6">
              ...
              <p className="text-gray-400">{league.registered} Players</p>
            </div>
            ...
            <div className="flex items-center justify-between mb-6">
              <div>
                ...
                <div className="flex items-center gap-2 mt-1">
                  ...
                  <span className="text-white font-semibold">{league.rating}</span>
                  <span className="text-gray-400">({league.reviewCount} reviews)</span>
                </div>
              </div>
