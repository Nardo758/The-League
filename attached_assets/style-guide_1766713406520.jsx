...
import { Trophy, Star, TrendingUp, Users, Bell, Check, X, AlertCircle, Info, Zap, Heart, Award } from 'lucide-react';
...
const StyleGuide = () => {
  ...
  const Buttons = () => (
    <div className="space-y-8">
      ...
      <div>
        ...
        <div className="flex flex-wrap gap-4">
          <button className="px-6 py-3 bg-blue-600 text-white rounded-lg font-semibold hover:bg-blue-700 flex items-center space-x-2">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          ...
          <div className="bg-gradient-to-br from-yellow-400 to-yellow-600 rounded-lg p-6 text-gray-900">
            ...
            <div className="flex items-center space-x-2">
              ...
              <span className="px-3 py-1 bg-white bg-opacity-40 rounded-full text-xs font-bold">
                3.5-4.0
              </span>
            </div>
          </div>
  ...
  return (
    <div className="min-h-screen bg-gray-50 flex">
      {/* Sidebar */}
      <div className="w-64 bg-white border-r border-gray-200 p-6 fixed h-screen overflow-auto">
        <div className="mb-8">
