...
import { Bell, BellRing, Filter, MapPin, Calendar, DollarSign, Users, Trophy, Clock, AlertCircle, CheckCircle, XCircle } from 'lucide-react';
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-gray-600 mt-1">Stay updated on leagues, tournaments, and events near you</p>
            </div>
            <button
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
            <div className="bg-white rounded-lg p-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                {/* Sports */}
                <div>
                  <h4 className="font-medium text-gray-900 mb-3">Sports to Follow</h4>
                  <div className="space-y-2">
                    {sports.slice(1).map(sport => (
                      <label key={sport.id} className="flex items-center space-x-3 cursor-pointer">
                        <input
                          type="checkbox"
                          checked={notificationSettings[sport.id]}
                  ...
                  <div className="space-y-2">
                    <label className="flex items-center space-x-3 cursor-pointer">
                      <input
                        ...
                        className="w-4 h-4 text-blue-600 rounded"
                      />
                      <span className="text-sm text-gray-700">New leagues & tournaments</span>
                    </label>
                    <label className="flex items-center space-x-3 cursor-pointer">
                      <input
                        type="checkbox"
                        ...
                        className="w-4 h-4 text-blue-600 rounded"
                      />
                      <span className="text-sm text-gray-700">Schedule changes & rain-outs</span>
                    </label>
                    <label className="flex items-center space-x-3 cursor-pointer">
                      <input
                        type="checkbox"
                        ...
                        className="w-4 h-4 text-blue-600 rounded"
                      />
                      <span className="text-sm text-gray-700">Results & standings updates</span>
                    </label>
                    <label className="flex items-center space-x-3 cursor-pointer">
                      <input
                        type="checkbox"
                        ...
                        className="w-4 h-4 text-blue-600 rounded"
                      />
                      <span className="text-sm text-gray-700">Registration deadlines & spots</span>
                    </label>
                  </div>
                </div>
        ...
        <div className="space-y-4">
          {filteredAnnouncements.map(announcement => (
            <div 
              ...
              className={`bg-white rounded-lg border-2 p-6 hover:shadow-lg transition-shadow ${
                announcement.urgent ? 'border-orange-300 bg-orange-50' : 'border-gray-200'
              }`}
            >
              <div className="flex items-start justify-between">
                <div className="flex-1">
                  ...
                  <div className="text-sm text-gray-600 mb-1">{announcement.venue}</div>
                  ...
                  {announcement.affectedTeams && (
                    <div className="mt-3">
                      <div className="text-sm font-medium text-gray-900 mb-1">Affected teams:</div>
                ...
                <div className="ml-4 text-right">
                  <div className="text-xs text-gray-500 mb-3">{announcement.timestamp}</div>
          ...
          {filteredAnnouncements.length === 0 && (
            <div className="text-center py-12">
              ...
              <div className="text-gray-500 text-lg">No announcements match your filters</div>
              <div className="text-gray-400 text-sm mt-1">Try adjusting your sport or type selection</div>
            </div>
          )}
        </div>
      </div>
